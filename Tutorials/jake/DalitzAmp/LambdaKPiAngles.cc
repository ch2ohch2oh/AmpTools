...
#include "DalitzAmp/LambdaKPiAngles.h"
...
LambdaKPiAngles::LambdaKPiAngles(const vector<string> &args) : UserAmplitude<LambdaKPiAngles>(args)
{
...
LambdaKPiAngles::calcAmplitude(GDouble **pKin) const
{
  ...
  // Not sure why such a frame is chosen
