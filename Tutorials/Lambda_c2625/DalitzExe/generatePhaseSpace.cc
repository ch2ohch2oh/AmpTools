...
int main(int argc, char **argv)
{
  ...
  if (argc <= 2)
  {
    cout << "Usage:" << endl
         << endl;
    cout << "\tgeneratePhaseSpace <output file name> <number of events>" << endl
         << endl;
    return 0;
  }
  ...
  cout << "... Finished creating a Data Writer" << endl
       << endl;
  ...
  const double lamc2625_mass = 2.62811;
  const double lamc_mass = 2.28646;
  const double pion_mass = 0.13957061;

  TLorentzVector parent(0.0, 0.0, 0.0, lamc2625_mass);
  double daughterMasses[3] = {lamc_mass, pion_mass, pion_mass};
